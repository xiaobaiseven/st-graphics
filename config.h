 ...
 */
static char *font = "Liberation Mono:style=Bold:pixelsize=15:antialias=true:autohint=true";
/* Spare fonts */
static char *font2[] = {
/*	"Inconsolata for Powerline:pixelsize=12:antialias=true:autohint=true", */
/*	"Hack Nerd Font Mono:pixelsize=11:antialias=true:autohint=true", */
    "Source Han Sans CN:style=Bold:pixelsize=15:antialias=true:autohint=true",
